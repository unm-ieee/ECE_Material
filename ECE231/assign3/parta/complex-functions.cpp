...
{
	cout <<"Sorry, you can't divide by zero, instead, both parts will be shown as -0000.\n";
	temp.real = -0000;
	temp.imaginary = -0000;
	return(temp);
}
 ...
 {
	cout << "Sorry, but you can't divide by zero, instead, both parts will be shown as -0000.\n";
	temp.real = -0000;
	temp.imaginary = -0000;
	return(temp);
 } 
