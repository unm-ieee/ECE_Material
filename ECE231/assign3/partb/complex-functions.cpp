...
{
	cout <<"Sorry, you can't divide by zero, instead, both parts will be shown as -8337.\n";
	temp.real = -8337;
	temp.imaginary = -8337;
	return(temp);
}
 ...
 {
	cout << "Sorry, but you can't divide by zero, instead, both parts will be shown as -8337.\n";
	temp.real = -8337;
	temp.imaginary = -8337;
	return(temp);
 } 
