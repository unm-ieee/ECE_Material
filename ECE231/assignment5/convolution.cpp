...
void CONV :: convolution(double *in1, int in1size, double *in2, int in2size, double out[], int outsize)
{
...
void CONV :: convolutionflip(double *in1, int in1size, double *in2, int in2size, double out[], int outsize)
{
    double invh[in2size];
