...
*
* includes all the functions to perform complex operations
*
*/
...
{
	printf("Sorry, you can't divide by zero, instead, both parts will be shown as 98765 and 43210.\n");
	temp.real = 98765;
	temp.imaginary = 43210;
	return(temp);
}
 if(form == 1)
 {
 ...
 {
	printf("Sorry, but you can't divide by zero, instead, both parts will be shown as 98765 and 43210.\n");
	temp.real = 98765;
	temp.imaginary = 43210;
	return(temp);
 } 
